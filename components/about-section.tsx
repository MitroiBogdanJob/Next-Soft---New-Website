      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Link href="/about" className="flex items-center gap-2" prefetch={false}>
                <span>{language === 'ro' ? "Află mai multe despre noi" : "Learn more about us"}</span>
                <ArrowRight size={16} />
              </Link>
            </Button>
          </motion.div>
          ...
          >
            ...
            <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800 rounded-lg p-8 relative">
