...
export default function AboutPage() {
  ...
  const milestones = [
    ...
    {
      year: "2017",
      title: language === 'ro' ? "Extindere în Dezvoltarea Mobilă" : "Expansion to Mobile Development",
      description: language === 'ro'
    ...
    {
      year: "2019",
      title: language === 'ro' ? "Integrarea Serviciilor Cloud" : "Cloud Services Integration",
      description: language === 'ro'
    ...
    {
      year: "2023",
      title: language === 'ro' ? "Lansarea Marketing-ului Digital" : "Digital Marketing Launch",
      description: language === 'ro'
  ...
  return (
    <div className="min-h-screen">
            ...
            >
              <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800 rounded-lg p-8">
                ...
                <div className="space-y-4">
                  {[
                    { name: t('about.values.excellence'), description: language === 'ro' ? "Ne străduim pentru excelență în fiecare proiect pe care îl întreprindem." : "We strive for excellence in every project we undertake." },
                    { name: t('about.values.innovation'), description: language === 'ro' ? "Îmbrățișăm inovația și rămânem în fruntea tehnologiei." : "We embrace innovation and stay at the forefront of technology." },
                    { name: t('about.values.integrity'), description: language === 'ro' ? "Operăm cu integritate și transparență în toate relațiile noastre." : "We operate with integrity and transparency in all our dealings." },
                    { name: t('about.values.client-focus'), description: language === 'ro' ? "Prioritizăm nevoile și succesul clienților noștri mai presus de toate." : "We prioritize our clients' needs and success above all else." }
                  ].map((value, index) => (
                    <motion.div 
                      key={index}
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-white">{value.name}</h4>
      ...
      <section className="py-20 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 to-blue-900/20 backdrop-blur-sm z-0"></div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              {language === 'ro' ? "Etape cheie în istoria companiei noastre" : "Key milestones in our company's history"}
            </p>
          </div>
